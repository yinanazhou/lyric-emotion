...
#SBATCH --output=run_output/xl_x_lr6_lc_sr_lemma_%A_%a.out
...
echo "Starting Task"
python xlnet_cv.py --ml 512 --bs 8 --epochs 500 --lr 6 --es $SLURM_ARRAY_TASK_ID --lc True --sr True --lemma True
