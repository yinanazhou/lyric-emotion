...
#SBATCH --output=run_output/xl_x_512_lc_nr_lemma_lr5_output_%A_%a.out
#SBATCH --gres=gpu:v100l:4
#SBATCH --cpus-per-task=1  # Cores proportional to GPUs: 6 on Cedar, 16 on Graham.
#SBATCH --mem=4G       # Memory proportional to GPUs: 32000 Cedar, 64000 Graham.
#SBATCH --array=15,20,25,30,35
...
echo "Starting Task"
python xlnet_cv.py --ml 512 --bs 8 --epochs 500 --lr 5 --es $SLURM_ARRAY_TASK_ID -lc True --nr True --lemma True
