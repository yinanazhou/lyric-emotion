...
ending_path = ('%s_%d_bs_%d_stop_%s_stem_%s_lemma_%s' %(model_str, MAX_LEN, batch_size, stop, stem, lemma))
...
if stop or stem or lemma:
    ...
    if stem:
        ...
        for i in range(len(tokenized_texts)):
            tokenized_texts[i] = [stemmer.stem(word) for word in tokenized_texts[i]]
