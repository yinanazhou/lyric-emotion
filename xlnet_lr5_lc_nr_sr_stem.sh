...
#SBATCH --output=run_output/xl_x_lr5_lc_nr_sr_stem_%A_%a.out
...
echo "Starting Task"
python xlnet_cv.py --ml 512 --bs 8 --epochs 500 --lr 5 --es $SLURM_ARRAY_TASK_ID --lc True --nr True --sr True --stem True
