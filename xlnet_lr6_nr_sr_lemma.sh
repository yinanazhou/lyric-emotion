...
#SBATCH --output=run_output/bert_x_lr6_nr_sr_lemma_%A_%a.out
...
echo "Starting Task"
python bert.py --ml 512 --bs 8 --epochs 500 --lr 6 --es $SLURM_ARRAY_TASK_ID --nr True --stop True --lemma True
