...
#SBATCH --output=run_output/bertTest_x_lr6_lc_nr_sr_lemma_%A_%a.out
...
echo "Starting Task"
python bert_test.py --ml 512 --bs 8 --epochs 500 --lr 6 --es 10 --lc True --nr True --stop True --lemma True
