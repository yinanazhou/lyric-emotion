...
#SBATCH --output=run_output/xl_x_lr7_lc_sr_stem_%A_%a.out
...
echo "Starting Task"
python xlnet_cv.py --ml 512 --bs 8 --epochs 500 --lr 7 --es $SLURM_ARRAY_TASK_ID --lc True --stop True --stem True
